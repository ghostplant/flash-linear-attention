...
def causal_conv1d(
    ...
    **kwargs,
    ...
    from fla2.modules.conv.cp import causal_conv1d_cp
    from fla2.modules.conv.cuda import causal_conv1d_cuda, fast_causal_conv1d_fn
    from fla2.modules.conv.triton import CausalConv1dFunction
